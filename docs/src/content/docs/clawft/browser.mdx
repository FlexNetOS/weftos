...
The WeftOS documentation site hosts an interactive browser sandbox at [weftos.weavelogic.ai/clawft/](https://weftos.weavelogic.ai/clawft/).

### Modes

| Mode | API Key Required | How It Works |
|------|:---:|------|
| **Local** | No | Pure keyword/semantic retrieval from the RVF knowledge base (1,160+ documentation segments) |
| **LLM** | Yes | RAG-powered answers: retrieves relevant KB segments, sends them as context to an LLM provider |
