...
**Feature**: `ecc`
**Source**: `crates/eml-core/` (standalone) + 16 domain-specific wrappers across 4 crates
**Phase**: K3c
...
16 EML models span 4 crates, replacing hardcoded heuristics across the entire WeftOS stack:
