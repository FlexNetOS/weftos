...
**EXPERIMENTAL (0.6.8)** — Iteration 0 of an EML-Transformer. Ships behind the `experimental-attention` feature on `eml-core`. Default builds are unchanged.
...
|------|---------|---------|-------|-------|--------|
| 0 (this) | 16 | 4-8 | 1 | hybrid toy block, pragmatic matmul | **shipped 0.6.8** |
| 1 | 32-64 | 12-16 | 2 | end-to-end coordinate descent, learned positional encodings | next |
| 2 | 96-128 | 24-32 | 4 | chunked attention, continual retraining on ExoChain drift | gated |
| 3 | 192-256 | 48-64 | 8 | sparse attention, shared constants | gated |
| 4+ | 256-512 | chunked | 16 | full hybrid attention+residual backbone | gated |
