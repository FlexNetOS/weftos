...
clawft ships as a minimal Alpine 3.21 Docker image containing pre-built musl
binaries downloaded from GitHub Releases. The resulting image is approximately
15 MB compressed. Multi-arch support covers `linux/amd64` and `linux/arm64`.
