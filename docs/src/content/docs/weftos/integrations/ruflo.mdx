...
[RuFlo](https://github.com/FlexNetOS/claude-flow) (claude-flow) is a multi-agent orchestration CLI that coordinates AI agent swarms. WeftOS can use RuFlo as an external swarm coordinator, and RuFlo can use WeftOS as its execution kernel.
